...
function.
Thus, the best the library can attain is to maximize the flexibility
...
(via \texttt{\small static\_assert}); this can provide much easier-to-understand
error messages than typical compiler output for templated C++ code.
